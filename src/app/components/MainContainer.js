  ...
  const getPlants = async (idRaspBerry) => {
    ...
    try {
      const snapshot = await get(
        ref(db, "raspberries/" + idRaspBerry + "/data/")
      );
      if (snapshot.exists()) {
        snapshot.val()["data"].forEach((childSnapshot) => {
          plants.push({...childSnapshot});
        });
          ...
          tabBarIcon: ({focused}) => (
            ...
            >
              <Image
                ...
                resizeMode="contain"
                style={{
                  tintColor: focused ? "#07D779" : "#FFFFFF",
                  marginTop: 17,
                }}
              />
              <Text
                style={{
                  color: focused ? "#07D779" : "#FFFFFF",
                  fontSize: 12,
                  paddingTop: 4,
                }}
              >
              ...
              <Image
                ...
                resizeMode="contain"
                style={{
                  tintColor: focused ? "#07D779" : "#00FF0000",
                  marginTop: "auto",
                }}
              />
            </View>
